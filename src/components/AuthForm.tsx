			...
			{session ? (
				...
				<div className="max-w-sm px-2 sm:mx-auto sm:w-full sm:max-w-md">
					<div className="relative rounded-lg bg-white px-6 py-6 shadow-lg dark:bg-gray-900 sm:px-10">
						<Image
							className="absolute left-0 right-0 top-0 mx-auto h-24 w-24 -translate-y-1/2 rounded-full bg-white object-contain p-3 dark:bg-gray-900"
							src="/logo.png"
							alt="Logo"
							width={72}
							height={72}
						...
						<div className="mt-6 flex justify-center gap-2 px-2 text-sm text-gray-500">
							<div>{variant === FormVariants.LOGIN ? "New to BinIt?" : "Already have an account?"}</div>
